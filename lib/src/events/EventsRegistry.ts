...
export class EventsRegistry {
	...
	public registerNotificationReceivedForeground(
		callback: (notification: Notification, completion: (response: NotificationCompletion) => void) => void
	): EmitterSubscription {
		return this.nativeEventsReceiver.registerNotificationReceived(
			this.completionCallbackWrapper.wrapReceivedForegroundCallback(callback)
		);
	}
	...
	public registerNotificationReceivedBackground(
		...
		return this.nativeEventsReceiver.registerNotificationReceived(
			this.completionCallbackWrapper.wrapReceivedBackgroundCallback(callback)
		);
	}

	public registerNotificationOpened(
		callback: (notification: Notification, completion: () => void, action?: NotificationActionResponse) => void
	): EmitterSubscription {
		return this.nativeEventsReceiver.registerNotificationOpened(
